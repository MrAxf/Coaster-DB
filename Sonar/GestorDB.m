...
-(void) ejecutaConsulta: (const char*) consulta esEjecutable: (BOOL) consultaEjecutable{
    sqlite3* baseDeDatos;
    NSString *caminoBD = [self.carpetaDocumentos stringByAppendingPathComponent:self.nombreBD];
...
- (void) executeQuery: (NSString*) consulta{
    [self ejecutaConsulta:[consulta UTF8String] esEjecutable:YES];
}
